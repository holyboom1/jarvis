...
class AppConstants {
  ...
  static const String kEnterModuleName =
      'Enter a module name (example_module): ';
  ...
  static const String kGoRouter = ' Is this a Go Router project? (yes/no): ';
  ...
  static const String kProjectDescription =
      'Please specify project description: ';
  static const String kJiraProjectPrefix =
      'Please specify jira project prefix: ';
  ...
  static const String kRemoteTemplatesLink =
      'https://github.com/holyboom1/dev_pilot_template';

  static const String kRemoteGoTemplatesLink =
      'https://github.com/holyboom1/jarvis_go_rourer_template';
  static const String kRemoteModuleTemplatesLink =
      'https://github.com/holyboom1/dev_pilot_module_template.git';

  static const String kRemoteGoModuleTemplatesLink =
      'https://github.com/holyboom1/dev_pilot_module_template_go_router.git';

  // Jarvis 2.0 Templates
  static const String kRemoteJarvis2AutoRouteTemplatesLink =
